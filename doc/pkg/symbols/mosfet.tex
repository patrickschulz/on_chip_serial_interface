...
\newif\if@circuits@mosfet@no@arrow
...
\tikzset{
    ...
    circuits/mosfet/no source arrow/.is if=@circuits@mosfet@no@arrow,
...
\pgfdeclareshape{genericmosshape}
{
    ...
    \saveddimen{\labelsep}{\pgf@x=\pgfkeysvalueof{/tikz/circuits/mosfet/label separation}}
    ...
    \anchor{gate}{\pgfpointadd{\pgfpointorigin}{%
        \if@circuits@mosfet@draw@bulk%
            \pgfpoint{-\channelheight -\gateskip}{0cm}%
        \else%
            \if@circuits@mosfet@no@arrow%
                \if@circuits@mosfet@nmos%
                    \pgfpoint{-\channelheight -\gateskip - 4 * \circleradius}{0cm}%
                \else%
                    \pgfpoint{-\channelheight -\gateskip - 2 * \circleradius}{0cm}%
                \fi%
            \else%
                \pgfpoint{-\channelheight -\gateskip}{0cm}%
            \fi%
    ...
    \beforebackgroundpath{
        ...
        \if@circuits@mosfet@draw@bulk
            \if@circuits@mosfet@no@arrow % draw bulk (with arrow)
                \begin{pgfscope}
