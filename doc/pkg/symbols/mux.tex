...
\pgfdeclareshape{muxshape}
{
    ...
    \beforebackgroundpath{
        ...
        \pgfpathclose
        \pgfusepath{stroke}
        %\pgftext[left, at={\inputplus}, x=2pt]{\pgfkeysvalueof{/tikz/circuits/ota/pin fontsize}0}
        \pgftext[right, at={\inputplus}, x=6pt]{\scriptsize\ttfamily 0}
        \pgftext[right, at={\inputminus}, x=6pt]{\scriptsize\ttfamily 1}
    }
}
